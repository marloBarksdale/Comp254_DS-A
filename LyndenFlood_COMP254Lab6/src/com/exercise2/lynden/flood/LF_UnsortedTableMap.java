...
/**
 * An implementation of a map using an unsorted table with containKey method.
 */
public class LF_UnsortedTableMap<K,V> extends AbstractMap<K,V> {
  /** Underlying storage for the map of entries. */
  private ArrayList<MapEntry<K,V>> table = new ArrayList<>();

  /** Constructs an initially empty map. */
  public LF_UnsortedTableMap() { }
  ...
  /**
   * Tests whether the map contains the specified key.
   * This method resolves ambiguity when null values are stored in the map.
